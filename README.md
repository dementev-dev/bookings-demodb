...
Некоторые внутренние настройки не вынесены на уровень пользователя: они присутствуют в исходном коде в виде постоянных функций (неудачные значения могут привести к ошибкам генерации или к неожиданным результатам) или только в виде констант.
